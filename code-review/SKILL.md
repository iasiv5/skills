---
name: code-review
description: 专业的代码审查助手。每当用户请求代码审查、检查PR、评估代码质量、寻找bug、安全漏洞分析、性能优化建议、代码重构建议、询问"这段代码有什么问题"、"代码写得怎么样"、"帮我看看这个PR"、"检查一下有没有bug"、"代码需要改进吗"、"是否符合最佳实践"、"审查commit"、"review代码"时，务必使用此skill。涵盖功能性、安全性、性能、测试、文档、架构设计等多维度代码质量评估。
---
...
撰写建设性反馈时，请参考 `resources/FEEDBACK-GUIDELINES.md` 获取详细指南，包括：

- **反馈原则**：建设性与尊重、清晰与具体、优先级分级
- **反馈模式**：提问式、建议式、解释式、赞赏式
- **常见场景示例**：安全问题、性能问题、代码质量、测试缺失等
- **特殊场景处理**：初级开发者代码、紧急修复、大型PR等
